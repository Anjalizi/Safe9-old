package com.example.android.hackeam.utils;
...
// Add the request to the RequestQueue.
    ...
    public static RequestQueue sendPatientDataRequest(RequestQueue queue, boolean isGetRequest,
        ...
        StringRequest request = new StringRequest(requestMethod, PATIENT_BASE_URL + urlParams,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d(QueryUtils.class.getSimpleName(), response);
