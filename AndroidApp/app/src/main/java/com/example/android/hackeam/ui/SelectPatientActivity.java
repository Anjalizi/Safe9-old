...
import com.example.android.hackeam.adapter.PatientAdapter;
import com.example.android.hackeam.data.PatientColumns;
...
import static com.example.android.hackeam.data.PatientProvider.Patients.URI_PATIENTS;
        ...
        try {
            ...
            if (cursor != null) {
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    mPatientsList.add(new Patient(userName,id,doctorName));
